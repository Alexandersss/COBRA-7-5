...
// STATIC HASH - COBRA 7.5 483

#if defined(FIRMWARE_4_83)  // Ported by Alexander's 13/10/2018

#define VSH_CEX_HASH					0xb6b6d000002e0000 // STATIC HASH COBRA 7.53 VSH
#define BDP_DISC_CHECK_PLUGIN_HASH		0x9940000000003000 // STATIC HASH COBRA 7.53
#define BASIC_PLUGINS_HASH				0x55f4700000010000 // STATIC HASH COBRA 7.53 done 483
#define EXPLORE_PLUGIN_HASH				0xc50d0000000e0000 // STATIC HASH COBRA 7.53
#define EXPLORE_CATEGORY_GAME_HASH		0xde52d00000050000 // STATIC HASH COBRA 7.53
#define PS1_EMU_HASH					0xcc28400000090000 // STATIC HASH COBRA 7.53 done 483
#define PS1_NETEMU_HASH 				0xcc284000000b0000 // STATIC HASH COBRA 7.53 done 483
#define GAME_EXT_PLUGIN_HASH			0xcc26800000010000 // STATIC HASH COBRA 7.53
#define PSP_EMULATOR_HASH				0xcc29b00000020000 // STATIC HASH COBRA 7.53
#define PEMUCORELIB_HASH				0x40425000000c0000 // STATIC HASH COBRA 7.53
#define EMULATOR_API_HASH				0x8409f00000010000 // STATIC HASH COBRA 7.53
#define EMULATOR_DRM_HASH				0xbbb8800000005000 // STATIC HASH COBRA 7.53
#define EMULATOR_DRM_DATA_HASH			0x2f3ab00000010000 // STATIC HASH COBRA 7.53
#define LIBSYSUTIL_SAVEDATA_PSP_HASH	0x0dfdc00000003000 // STATIC HASH COBRA 7.53
#define LIBFS_EXTERNAL_HASH				0x05fd000000006000 // STATIC HASH COBRA 7.53
...
/* basic_plugins */// 4.83 CEX - same as 4.78
...
/* bdp_disccheck_plugin */ //  the same as 4.46 - 4.83
...
/* libfs (external */ // The same as 4.55 - 4.83
